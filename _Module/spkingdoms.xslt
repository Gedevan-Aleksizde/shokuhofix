<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="Kingdom[@id='ashina']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=qO2LaEJH}Ashina</xsl:attribute>
			<xsl:attribute name='title'>{=qO2LaEJH}Ashina</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='soma']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=lVx3gqqL}Souma</xsl:attribute>
			<xsl:attribute name='title'>{=lVx3gqqL}Souma</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='date']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=fKx72A6I}Date</xsl:attribute>
			<xsl:attribute name='title'>{=fKx72A6I}Date</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='mogami']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=9vBSHbyz}Mogami</xsl:attribute>
			<xsl:attribute name='title'>{=9vBSHbyz}Mogami</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='ando']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=xU6k7DMZ}Andou</xsl:attribute>
			<xsl:attribute name='title'>{=xU6k7DMZ}Andou</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='nanbu']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=lOrWIIfh}Nanbu</xsl:attribute>
			<xsl:attribute name='title'>{=lOrWIIfh}Nanbu</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='hojo']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=WhlNAwBH}Houjou</xsl:attribute>
			<xsl:attribute name='title'>{=WhlNAwBH}Houjou</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='satomi']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=3HM2LZLz}Satomi</xsl:attribute>
			<xsl:attribute name='title'>{=3HM2LZLz}Satomi</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='utsunomiya']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=9iMMapjE}Utsunomiya</xsl:attribute>
			<xsl:attribute name='title'>{=9iMMapjE}Utsunomiya</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='satake']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=ijCa8pDo}Satake</xsl:attribute>
			<xsl:attribute name='title'>{=ijCa8pDo}Satake</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='asakura']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=Hwgq2oHf}Asakura</xsl:attribute>
			<xsl:attribute name='title'>{=Hwgq2oHf}Asakura</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='anekouji']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=QqEJybge}Anekouji</xsl:attribute>
			<xsl:attribute name='title'>{=QqEJybge}Anekouji</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='tokugawa']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=nAUwT8JG}Tokugawa</xsl:attribute>
			<xsl:attribute name='title'>{=nAUwT8JG}Tokugawa</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='uesugi']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=r3wkuN0u}Uesugi</xsl:attribute>
			<xsl:attribute name='title'>{=r3wkuN0u}Uesugi</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='honjo']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=ASyaMblp}Honjou</xsl:attribute>
			<xsl:attribute name='title'>{=ASyaMblp}Honjou</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='takeda']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=AZkHq9Al}Takeda</xsl:attribute>
			<xsl:attribute name='title'>{=AZkHq9Al}Takeda</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='imagawa']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=nJmwT7OT}Imagawa</xsl:attribute>
			<xsl:attribute name='title'>{=nJmwT7OT}Imagawa</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='akamatsu']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=7EInH5Hq}Akamatsu</xsl:attribute>
			<xsl:attribute name='title'>{=7EInH5Hq}Akamatsu</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='ashikaga']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=hMz5eeje}Ashikaga</xsl:attribute>
			<xsl:attribute name='title'>{=hMz5eeje}Ashikaga</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='hatakeyama']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=4cnmTBU0}Hatakeyama</xsl:attribute>
			<xsl:attribute name='title'>{=4cnmTBU0}Hatakeyama</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='rokkaku']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=PGOSBt3d}Rokkaku</xsl:attribute>
			<xsl:attribute name='title'>{=PGOSBt3d}Rokkaku</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='azai']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=0PavuhnS}Azai</xsl:attribute>
			<xsl:attribute name='title'>{=0PavuhnS}Azai</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='oda']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=cM7eTAK1o}Oda</xsl:attribute>
			<xsl:attribute name='title'>{=APfBTaqg9}Oda</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='uragami']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=KolhtpUd}Uragami</xsl:attribute>
			<xsl:attribute name='title'>{=KolhtpUd}Uragami</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='amago']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=LE5jbPP4}Amago</xsl:attribute>
			<xsl:attribute name='title'>{=LE5jbPP4}Amago</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='ichijo']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=44ThIRyK}Ichijou</xsl:attribute>
			<xsl:attribute name='title'>{=44ThIRyK}Ichijou</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='chosokabe']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=do4c1Wld}Chousokabe</xsl:attribute>
			<xsl:attribute name='title'>{=do4c1Wld}Chousokabe</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='miyoshi']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=YhbInKsq}Miyoshi</xsl:attribute>
			<xsl:attribute name='title'>{=YhbInKsq}Miyoshi</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='shimazu']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=e89d6Fhr}Shimazu</xsl:attribute>
			<xsl:attribute name='title'>{=e89d6Fhr}Shimazu</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='kimotsuki']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=nuOTMFnL}Kimotsuki</xsl:attribute>
			<xsl:attribute name='title'>{=nuOTMFnL}Kimotsuki</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='ito']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=0rDc1SBx}Itou</xsl:attribute>
			<xsl:attribute name='title'>{=0rDc1SBx}Itou</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='aso']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=EFBD0B8}Aso</xsl:attribute>
			<xsl:attribute name='title'>{=EFBD0B8}Aso</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='sagara']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=qZ86Dhcd}Sagara</xsl:attribute>
			<xsl:attribute name='title'>{=qZ86Dhcd}Sagara</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='otomo']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=p6llIAZ9}Ōtomo</xsl:attribute>
			<xsl:attribute name='title'>{=p6llIAZ9}Ōtomo</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='arima']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=HCBBJbxX}Arima</xsl:attribute>
			<xsl:attribute name='title'>{=HCBBJbxX}Arima</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
	...
	<xsl:template match="Kingdom[@id='ryuzoji']">
		<xsl:copy>
			...
			<xsl:attribute name='short_name'>{=5HSblONo}Ryūzouji</xsl:attribute>
			<xsl:attribute name='title'>{=5HSblONo}Ryūzouji</xsl:attribute>
			<xsl:attribute name='ruler_title'>{=tRwThwR8}Daimyou</xsl:attribute>
