<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="Settlement[@id='castle_AMA1']">
        <xsl:copy>
            ...
            <xsl:attribute name='name'>{=R6gnCH7g}Kouno Castle</xsl:attribute>
        	<xsl:apply-templates select="node()"/>
		</xsl:copy>
    </xsl:template>
    ...
    <xsl:template match="Settlement[@id='castle_village_CHUB24_1']">
        <xsl:copy>
			<xsl:apply-templates select="@*"/>
            <xsl:attribute name='name'>{=RVCdQOAQ}Arai-minato</xsl:attribute>
        	<xsl:apply-templates select="node()"/>
		</xsl:copy>
    </xsl:template>
    ...
    <xsl:template match="Settlement[@id='castle_KIN21']">
        <xsl:copy>
			<xsl:apply-templates select="@*"/>
            <xsl:attribute name='name'>{=rogs3NNl}Sakuma-Kameyama Castle</xsl:attribute>
        	<xsl:apply-templates select="node()"/>
		</xsl:copy>
    </xsl:template>
